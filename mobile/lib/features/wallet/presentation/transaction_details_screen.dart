        ...
        child: Column( // Organiza as informações em coluna vertical. 
          children: [ // Filhos da tela de comprovante. 
            ...
            Text( // Exibe o valor da transação em destaque. 
              "${transacao['Tokens Comprados'] ?? transacao['Tokens Vendidos'] ?? 0} $ticker", // Texto formatado (ex: "+10 AGRI3"). 
            ...
            Text( // Exibe o valor aproximado em Reais. 
              "R\$ ${(transacao['Preco Pago'] as num?)?.toStringAsFixed(2) ?? '0.00'}", // Valor financeiro simulado da transação. 
              style: const TextStyle(color: Colors.grey), // Cor cinza discreta. 
            ), // Fim do texto. 
            ...
            Container( // Caixa cinza que contém os dados técnicos da operação. 
              ...
              child: Column( // Organiza as linhas de detalhe em coluna. 
                ...
                //Ela recebe um rótulo (label) e um valor (value) e retorna uma linha de texto. 
                  _buildDetailRow("Data", dataFormatada), // Linha que mostra a data da operação. 
                  _buildDetailRow("Status", transacao['status'] ?? 'Sucesso', isStatus: true), // Linha que mostra o status (verde). 
